...
public final class MainActivity extends Activity {
    ...
    private void render() {
        ...
        root.addView(Ui.body(this, "v0.1.20 · 화면을 열지 않고 예약 프롬프트를 실행하는 Android 앱"));

        root.addView(Ui.section(this, "선택 기능 · 오토런 중계"));
        root.addView(Ui.body(this, "요구사항만 입력하면 프로젝트 대화를 자동 준비하는 Protocol 3.3 중계입니다. 예약 작업이 항상 우선합니다."));
        root.addView(Ui.button(this, "오토런 중계 열기", v -> startActivity(new Intent(this, OrchestrationHistoryActivity.class))));
        ...
        try {
            ...
            if (NotificationHelper.orchestrationAlertsEnabled(this)) {
                NotificationHelper.orchestrationError(this, relay.monitoringSide(), relay.runJobId(),
                        relay.currentStep(), relay.currentRound(), "앱 재실행 후 오토런 중계 서비스를 복구하지 못했습니다.");
            }
        }
    }

...
- 공개 저장소 하나만으로 테스트, APK 빌드, 서명, GitHub Release 생성까지 수행한다.
...
3. APK ZIP 무결성과 SHA-256을 검증한다.
4. 생성한 APK와 소스 ZIP을 같은 공개 저장소의 GitHub Release에 게시한다.
5. 다른 저장소, 과거 비공개 Release 또는 외부 비밀 저장소를 빌드 의존성으로 사용하지 않는다.
